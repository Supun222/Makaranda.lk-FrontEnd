...
function EditLocation({ locID, locname, locLatitude, locLongtitude }) {
  const LocID = locID;
  const [name, setName] = useState(locname);
  const [latitude, setDetails] = useState(locLatitude);
  const [longtitude, setPrice] = useState(locLongtitude);
